...
<head>
    ...
    <link href="<?php echo e(asset('https://data.jsdelivr.com/v1/package/npm/paper-dashboard/badge')); ?>" rel="stylesheet"/>

    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="<?php echo e(asset('https://cdnjs.cloudflare.com/ajax/libs/jquery-ui-bootstrap/0.5pre/css/demo.css')); ?>" rel="stylesheet"/>
    <link href="<?php echo e(asset('https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css')); ?>" rel="stylesheet"/>
    ...
    <div class="sidebar" data-background-color="white" data-active-color="danger">
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="<?php echo e(route('me.profile')); ?>" class="topicos">
                        <i class="ti-user"></i>
                        <p>User Profile</p>
                    </a>
                </li>
